...
function address(value: string, family: 'IPv4' | 'IPv6' = 'IPv4', internal = false): NetworkInterfaceInfo {
  const base = {
    address: value,
...
test('listLanIPv4 removes duplicate addresses', () => {
  assert.deepEqual(listLanIPv4({ en0: [address('192.168.1.8')], en1: [address('192.168.1.8')] }), ['192.168.1.8'])
})
